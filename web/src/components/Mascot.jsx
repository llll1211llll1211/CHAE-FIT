...
/**
 * 성장 마스코트 — chafit-signal(이나린) components/Mascot.tsx 원본 이식.
 * 타입 표기만 걷어냈고 로직·마크업·클래스는 그대로다.
 *
 * 커버리지 구간(0/25/50/75/100)에 따라 5단계로 자란다. 단계가 올라가는 순간에만
 * 0.7초 축하 모션이 돈다 — 내려갈 때는 아무 일도 일어나지 않는다.
 */
...
export default function Mascot({ pct }) {
  ...
  return (
    ...
    >
      <span className={styles.grow} style={{ '--mascot-scale': STAGE_SCALE[stage] }}>
